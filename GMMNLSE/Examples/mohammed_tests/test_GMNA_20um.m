...
fiber_Gain.MFD = 15; % mode-field diameter
fiber_Gain.L0 = 2.4;
...
save("C:\Users\ms2106\.julia\dev\Luna\examples\mohammed\data_3m"+".mat", ...
     "prop_output");
...
% for i = 10:30
%      disp(i)
%      [wavelength, spectrum, spectra, Strehl_ratio,dechirped_FWHM,transform_limited_FWHM,peak_power] = analyze_field( t,f,prop_output.fields(:,1,i),'Treacy-t',pi/6,1e-6, false, true, []);
...
% [wavelength, spectrum, spectra, Strehl_ratio,dechirped_FWHM,transform_limited_FWHM,peak_power] = analyze_field( t,f,prop_output.fields(:,1,23),'Treacy-t',pi/6,1e-6, true, true, []);